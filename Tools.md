...
2. Công cụ thiết kế Giao diện (UI Controls trong XAML / Blazor)
...
- ListView / CollectionView (kết hợp ViewCell và DataTemplate): Dùng để hiển thị danh sách các tài khoản người dùng kèm vai trò/quyền hiện tại.
...
4. Dependency Injection (MS.DI) & Tầng Dịch vụ (Service Layer)
